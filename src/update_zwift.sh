...
update_zwift_using_launcher() {
    ...
    if ! GAMEID=umu-zwift PROTONPATH="/home/user/.local/share/Steam/compatibilitytools.d/GE-Proton10-34/" umu-run ZwiftLauncher.exe SilentLaunch; then
...
#    wget https://cdn.zwift.com/app/ZwiftSetup.exe || return 1
    GAMEID=umu-zwift PROTONPATH="/home/user/.local/share/Steam/compatibilitytools.d/GE-Proton10-34/" umu-run /home/user/ZwiftSetup.exe /SP- /VERYSILENT /SUPPRESSMSGBOXES /NORESTART /NOCANCEL || return 1
}
